...
$tasks = @(
    ...
    @{ file = '02_basic_syntax\comments_and_input_output.md'; line = 34; output = '02_basic_syntax\images\comments_and_input_output_01.png' },
    ...
    @{ file = '03_advanced_syntax\functional_programming_and_recursion.md'; line = 34; output = '03_advanced_syntax\images\functional_programming_and_recursion_01.png' },
    ...
    @{ file = '03_advanced_syntax\file_io_and_pathlib.md'; line = 34; output = '03_advanced_syntax\images\file_io_and_pathlib_01.png' },
    @{ file = '03_advanced_syntax\structured_data_formats.md'; line = 34; output = '03_advanced_syntax\images\structured_data_formats_01.png' },
    ...
    @{ file = '04_progressive_topics\standard_library_toolbox.md'; line = 34; output = '04_progressive_topics\images\standard_library_toolbox_01.png' },
    @{ file = '04_progressive_topics\logging_and_cli_automation.md'; line = 34; output = '04_progressive_topics\images\logging_and_cli_automation_01.png' },
